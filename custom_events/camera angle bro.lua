function onEvent(eventName, value1, value2, strumTime)
    if eventName == 'camera angle bro' then
            doTweenAngle('CamTween1', 'camGame', value1, value2, 'quartOut')
    end
end

-- Camera Angle Tilting and Movoing by gen.zu.
-- Camera Fix by raltyro.
...
function onCreatePost()
    if oppMode and not middleScroll then
